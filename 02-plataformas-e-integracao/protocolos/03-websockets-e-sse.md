...
Com este capítulo, concluímos o submódulo de **Protocolos**. Agora você possui uma base sólida sobre a infraestrutura da Web: desde o tráfego de pacotes e resolução DNS até a anatomia de requisições HTTP e a comunicação em tempo real com SSE e WebSockets.

---

<a href="02-o-protocolo-http-e-https.md">← O Protocolo HTTP e HTTPS</a>

<p align="right"><a href="../browser/manipulacao-do-dom/01-a-arvore-do-dom-e-renderizacao.md">Explorar: Manipulação do DOM →</a></p>
