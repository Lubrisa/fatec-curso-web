...
codes e cabeçalhos, estamos prontos para explorar outros modelos de comunicação
em tempo real que complementam o modelo clássico de requisição e resposta.

No **[Capítulo 03: WebSockets e Server-Sent Events
(SSE)](03-websockets-e-sse.md)**, vamos entender como funcionam canais
bidirecionais contínuos e fluxos de dados em tempo real na plataforma web.

---

<a href="01-fundamentos-de-redes-na-web.md">← Fundamentos de Redes na Web</a>

<p align="right"><a href="03-websockets-e-sse.md">Próximo: WebSockets e Server-Sent Events (SSE) →</a></p>
